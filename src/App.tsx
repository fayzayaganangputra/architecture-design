  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="text-2xl font-bold text-blue-800">ArchDesign</div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span>info@archdesign.co.id</span>
                </div>
                <div className="flex items-center gap-4">
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-400 mb-4">ArchDesign</div>
            <p className="text-gray-400">
              © 2024 ArchDesign. Semua hak cipta dilindungi undang-undang.
            </p>
          </div>
        </div>
      </footer>
